...
//pcl::PointCloud<pcl::PointXYZINormal> point_cloud_read;
//PointCloudXYZI::Ptr point_cloud_read(new PointCloudXYZI());
        ...
        if(sync_packages(Measures)) 
        {
            ...
            if(!init_map)
            {
                ...
                // if(feats_down_size > 5)
                {
                    ...
                    if(pcl::io::loadPCDFile<pcl::PointXYZINormal>(string(string(ROOT_DIR) + "PCD/") + file_name, *init_feats_world) == -1)
                    {
